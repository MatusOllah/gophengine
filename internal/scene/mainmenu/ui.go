...
func MakeUI(ctx *context.Context, shouldExit *bool) (*ebitenui.UI, error) {
	...
	exitDialogContainer.AddChild(widget.NewButton(
		...
		widget.ButtonOpts.Text(i18nutil.L(ctx.Localizer, "Exit"), regularFace, &widget.ButtonTextColor{
	...
	exitDialogContainer.AddChild(widget.NewButton(
		...
		widget.ButtonOpts.Text(i18nutil.L(ctx.Localizer, "Stay"), regularFace, &widget.ButtonTextColor{
	...
	exitDialogContainer.AddChild(widget.NewLabel(
		widget.LabelOpts.Text(i18nutil.L(ctx.Localizer, "ExitDialogText"), regularFace, &widget.LabelColor{color.NRGBA{0xFF, 0xFF, 0xFF, 0xFF}, color.NRGBA{0xFF, 0xFF, 0xFF, 0xFF}}),
	))
	...
	titleBarContainer.AddChild(widget.NewLabel(
		widget.LabelOpts.Text(i18nutil.L(ctx.Localizer, "Exit"), titleFace, &widget.LabelColor{color.NRGBA{0xFF, 0xFF, 0xFF, 0xFF}, color.NRGBA{0xFF, 0xFF, 0xFF, 0xFF}}),
